...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">.
        <div class="row header_part">
            <div class="col-12">
                <h1 class="ddheadline"><img src="{{url('/public/img/icons/60riders32.png')}}" width="36" height="36" /> Add new Rider</h1>
            </div>
            <hr>
        </div>
        <div class="row">
                        ...
                        <form role="form" method="post" action="{{route( strtolower($pageTitle) . '.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <!---CONTROL BUTTON--->
                                    <div class="form-group">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i> Add Rider</button>
                                    </div>
                                </div>
                            </div>
                        </form>
