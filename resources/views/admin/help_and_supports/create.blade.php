...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row header_part">
            <div class="col-12">
                <h1 class="ddheadline"><img src="{{url('/public/img/icons/91heplandsupport32.png')}}" width="36" height="36" /> Add a Query</h1>
            </div>
            <hr>
        </div>
        <div class="row">
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="row">
                               <div class="col-12">
                                   <!---CONTROL BUTTON--->
                                   <div class="form-group">
                                       <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i> Add Query</button>
                                   </div>
                               </div>
                            </div>
                         </form>
