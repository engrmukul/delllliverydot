                            ...
                            <form role="form" method="post" action="{{route( strtolower($pageTitle) . '.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <!--- Course category --->
                                        <div class="form-group">
                                            <label for="course_category_id">{{ trans('course.course_category_id')}}</label>
                                            <select id="course_category_id" class="form-control custom-select mt-15" name="course_category_id" required>
                                                <option value="">{{ trans('course.course_category_id')}}</option>
                                                @foreach($courseCategories as $key => $courseCategory)
                                                    @if (old('course_category_id') == $courseCategory->id)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="instructor_id" class="form-control custom-select mt-15" name="instructor_id" required>
                                                ...
                                                @foreach($instructors as $key => $instructor)
                                                    @if (old('instructor_id') == $instructor->id)
