                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="delivery_fee" value="{{ old('delivery_fee', $restaurant->restaurantDetails->delivery_fee) }}" placeholder="{{ trans('restaurant.delivery_fee')}}" class="form-control currency_symbol" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="delivery_time" value="{{ old('delivery_time', $restaurant->restaurantDetails->delivery_time) }}" placeholder="{{ trans('restaurant.delivery_time')}}" class="form-control minute_input" required>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="delivery_range" value="{{ old('delivery_range', $restaurant->restaurantDetails->delivery_range) }}" placeholder="{{ trans('restaurant.delivery_range')}}" class="form-control range_input" required>
                                    ...
                                    <div class="form-group discount d-none">
                                        <label for="discount" class="font-bold currency_symbol">{{ trans('restaurant.discount')}}<span class="currency_symbol">(&#2547;)</span></label>
                                        <input type="number" name="discount" value="{{ old('discount', $restaurant->restaurantDetails->discount) }}" placeholder="{{ trans('restaurant.discount')}}" class="form-control currency_symbol">
