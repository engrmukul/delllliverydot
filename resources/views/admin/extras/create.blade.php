            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5><i class="fa fa-book"></i> extra {{ trans('common.create')}}</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" placeholder="{{ trans('extra.name')}}" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" placeholder="{{ trans('extra.description')}}" class="form-control summernote" required>{{ old('description') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="price" name="price" value="{{ old('price') }}" placeholder="{{ trans('extra.price')}}" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="extra_group_id" class="form-control custom-select mt-15" name="extra_group_id" required>
                                            ...
                                            @foreach($groups as $key => $group)
                                                @if (old('extra_group_id') == $group->id)
