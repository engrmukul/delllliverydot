                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $foodCategory->name) }}" placeholder="{{ trans('foodCategory.name')}}" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description"
                                                  ...
                                                  required>{{ old('description', $foodCategory->description) }}</textarea>
